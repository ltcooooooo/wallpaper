          ...
          <Card :data="item" type="video" page="videoFavorites" v-slot="CD" >
            <section
              ...
              <div class="text-white">
                  <my-tooltip content="取消收藏">
                      <el-button type="warning" size="small" @click="CD.delFavoritesImage"><i-ms-kid-star /></el-button>
                  </my-tooltip>
...
<script setup>
import { ref } from "vue";
import { useVideoList } from "@renderer/composables/useFavoriteList";
import { filesize } from "filesize";

const listRef = ref(null);
const { favoritesList, page, paginationHide, pageChange } = useVideoList({ listRef });
